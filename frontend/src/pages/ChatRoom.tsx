...
export const ChatRoom = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-dark-bg via-dark-bg-darker to-dark-bg flex flex-col">
      {/* Header */}
