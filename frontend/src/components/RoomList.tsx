...
export default function RoomList({ rooms, onRoomSelect, selectedRoomId }: RoomListProps) {
      ...
      <div className="space-y-2">
        {rooms.map((room) => (
          <button
            ...
            className={`w-full text-left p-3 hover:bg-dark-bg/50 rounded-xl transition group relative overflow-hidden ${room._id === selectedRoomId ? 'bg-dark-bg/30 border border-primary' : ''}`}
          >
